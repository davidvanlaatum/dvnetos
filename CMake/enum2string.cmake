function(enum2string)
  ...
  add_custom_command(
      ...
      COMMAND ${PYTHON_VENV} ${ENUM2STRING} ${CMAKE_CURRENT_SOURCE_DIR}/${ARG_HEADER} ${CMAKE_CURRENT_SOURCE_DIR}/${HEADER_NAME}_tostring.cpp ${CMAKE_CURRENT_SOURCE_DIR}/${HEADER_NAME}_tostring.h -std=c++$<TARGET_PROPERTY:${ARG_TARGET},CXX_STANDARD> "-I$<JOIN:$<TARGET_PROPERTY:${ARG_TARGET},INCLUDE_DIRECTORIES>,;-I>"
